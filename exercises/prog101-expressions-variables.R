...
# Line 3 computes the area by multiplying the length and width of a rectangle
...
# Line 11 should not be indented. Line 12 doesn't have underscores in first term. Line 13 doesn't have -
# only < and should be multiplied not added
...
energy_squid_density_J_g <- 4850
squid_mass_g <- 35 
dolphin_energy_J <- 5000000
energy_squid_J <- energy_squid_density_J_g * squid_mass_g
squids_to_eat <- dolphin_energy_J / energy_squid_J
