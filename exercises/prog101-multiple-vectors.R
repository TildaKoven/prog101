...
# it converts the time into an hour with a decimal
...
# the durations are in hours with a decimal
...
which.max(instrument_durations)
site[which.max(instrument_durations)]
longest_durations <- site[instrument_durations == max(instrument_durations)]
